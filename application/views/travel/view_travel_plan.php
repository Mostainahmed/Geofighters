    ...
    <div class="container-fluid">
        ...
        <div class="row pt-3">
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item active">Travel Plan</li>
                </ol>
            </div>
            <!-- <div class="col-sm-6">
        ...
        <div class="row pt-0">
            <div class="col-12">
                ...
                <table style="width:100%" class="table_travel_plan table-hover table-bordered table-sm text-center">
                </table>
            </div>
        </div>
    </div>
...
$('.table_travel_plan').DataTable({
    ...
    ajax: {
        url: "<?php echo base_url(); ?>travel/get_travel_plan_list_serverside",
        type: 'POST',
    ...
    columns: [
        ...
        },
        {
            ...
            render: function(data, type, service) {
                ...
                let edit_button = '<a class="" href="javascript:void(0)" onclick="update_region(\'' +
                    data.region_id +
                ...
                let accept_button =
                    ...
                    data.travel_plan_id +
                    '\');"><button type="button" class="btn btn-success btn-xs"><i class="fas fa-check-circle"></i> Accept</button></a>'
                return edit_button + '&nbsp;' + accept_button;
            }
        },
    ],
...
function accept_travel_plan(travel_plan_id) {
    ...
    //return;
    Swal.fire({
        title: 'Do you want to Accept this Travel Plan?',
        type: 'question',
...
$('#navlink_travel_plan').addClass('active');
</script>