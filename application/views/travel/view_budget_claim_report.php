    ...
    <div class="container-fluid">
        ...
        <div class="row pt-0">
            <div class="col-12">
                ...
                <table style="width:100%" class="table_budget_claim table-hover table-bordered table-sm text-center">
                </table>
            </div>
        </div>
    </div>
...
$('.table_budget_claim').DataTable({
    ...
    ajax: {
        url: "<?php echo base_url(); ?>travel/get_budget_claim_list_serverside",
        type: 'POST',
        ...
        },
        {
            ...
            render: function(data, type, service) {
                ...
                let details_button = '<a class="" href="javascript:void(0)" onclick="view_travel_cost_detail_modal(\'' +
			 	...
			 	let image_button = '<a class="umodal__open" href="<?php echo "http://10.10.111.33/geofighters/uploads/bills/";?>'+data.bill_image+' " ><button type="button" class="btn btn-primary btn-xs"><i class="fas fa-image"></i> Voucher</button></a>';
			
        
                let accept_button =
                    '<a class="" href="javascript:void(0)" onclick="accept_travel_plan(\'' +
                    data.travel_plan_id +
                    '\');"><button type="button" class="btn btn-success btn-xs"><i class="fas fa-check-circle"></i> Approve</button></a>'
                return details_button + '&nbsp;' + image_button + '&nbsp' + accept_button;
            }
        },
    ],
...
$('#navlink_budget_claim').addClass('active');
</script>